...
Cham <- 3 #Chamber labeled to prevent subsequent confusion
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 4 Chamber 3") + geom_hline(aes(yintercept=0)) +
  labs(x="Loops", y=expression(MO[2]~(mgO[2]~kg^-1~h^-1))) 
```
Some photosynthesis happening
...
#write.csv(corrected.data, "Trial4Chamber3NoBG.csv")
