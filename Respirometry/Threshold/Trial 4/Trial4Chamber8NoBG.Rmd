...
```
That looks like good photosynthesis
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 4 Chamber 8") + geom_hline(aes(yintercept=0)) +
  labs(x="Loops", y=expression(MO[2]~(mgO[2]~kg^-1~h^-1))) 
```
Decent day/night cycles
...
#write.csv(corrected.data, "Trial4Chamber8NoBG.csv")
