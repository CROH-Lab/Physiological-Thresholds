...
Cham <- 6 #Chamber labeled to prevent subsequent confusion
...
```
Not seeing much photosynthesis here
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 4 Chamber 6") + geom_hline(aes(yintercept=0)) +
  labs(x="Loops", y=expression(MO[2]~(mgO[2]~kg^-1~h^-1))) 
```
Consistently unhappy coral
...
#write.csv(corrected.data, "Trial4Chamber6NoBG.csv")
