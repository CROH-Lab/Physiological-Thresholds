...
```
Looks okay I think. Mostly negative
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 3 Chamber 3") + geom_hline(aes(yintercept=0)) +
...
#write.csv(corrected.data, "Trial3Chamber3NoBG.csv")
