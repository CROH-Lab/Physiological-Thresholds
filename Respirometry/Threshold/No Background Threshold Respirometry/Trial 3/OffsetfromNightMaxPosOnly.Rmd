---
title: "Trial 3 Night Max Is Zero"
author: "Abby Cannon"
date: "2024-10-08"
...
unique(datos$Time.of.Day) #Looks good
...
ggplot(calc, aes(x= Hour, y= MO2.from.Dark.Max, 
  ...
  theme_bw()
```
That actually looks pretty good other than 15 on night 3, but it will probably come out in the wash

Let's get our data ready for subsequent programming
```{r}
#write.csv(calc, "Trial3FromNightMaxPosOnly.csv")
```