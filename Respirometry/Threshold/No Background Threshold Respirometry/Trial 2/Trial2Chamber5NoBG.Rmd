...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 2 Chamber 5") + geom_hline(aes(yintercept=0)) +
...
#write.csv(corrected.data, "Trial2Chamber5NoBG.csv")
