...
```
Somewhat better breathing during the day
...
```
Some photosynthesis, which is nice
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 4 Chamber 1") + geom_hline(aes(yintercept=0)) +
...
[1] "AutoResp.Cycle.Loop"           "Chamber"                      
 [3] "MO2 no Background Correction"  "Hour"                         
 [5] "Treatment"                     "Time.of.Day"                  
 [7] "Day"                           "MO2"                          
 [9] "Genotype"                      "X"                            
[11] "X.1"                           "X.2"                          
[13] "X.3"                           "X.4"                          
[15] "Experiment.starts.at.cycle.11"
...
#write.csv(corrected.data, "Trial4Chamber1NoBG.csv")
