...
```
Might be doing better over time, which is surprising
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 9 Chamber 8") + geom_hline(aes(yintercept=0)) +
...
#write.csv(corrected.data, "Trial9Chamber8NoBG.csv")
