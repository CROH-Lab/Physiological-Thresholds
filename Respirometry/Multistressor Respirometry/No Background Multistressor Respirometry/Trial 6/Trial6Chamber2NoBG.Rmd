...
```
We have a few weird ones, but hopefully Briana identified them
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 6 Chamber 2") + geom_hline(aes(yintercept=0)) +
  labs(x="Loops", y=expression(MO[2]~(mgO[2]~kg^-1~h^-1))) 
```
Night 2 was quite something it looks like
...
#write.csv(corrected.data, "Trial6Chamber2NoBG.csv")
