...
unique(datos$Time.of.Day) #Only 2. Perfect

#How to make separate categories for day and night
...
unique(dia$Hour) #This one appears not to be the problem
```
...
```
So these are all negative and therefore probably fine.
