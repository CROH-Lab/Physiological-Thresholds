...
```
Well maybe photosynthesis and respiration both decreace over time
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 7 Chamber 7") + geom_hline(aes(yintercept=0)) +
...
#write.csv(corrected.data, "Trial7Chamber7NoBG.csv")
