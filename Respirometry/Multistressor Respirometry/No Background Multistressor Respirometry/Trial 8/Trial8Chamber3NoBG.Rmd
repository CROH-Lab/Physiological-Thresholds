...
```
More increasing respiration

Still a tendency for respiration to increase over time.
...
```
Looks better than some of the previous ones
...
```
Things may have gotten a bit weird in this one
...
```
And when we correct it just looks odd
...
#write.csv(corrected.data, "Trial8Chamber3NoBG.csv")
