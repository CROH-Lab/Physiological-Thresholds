...
```
Looks okay-ish although more consumption earlier
...
```
And we've got the same old issue, but hopefully we can fix it in post
...
#write.csv(corrected.data, "Trial8Chamber8NoBG.csv")
