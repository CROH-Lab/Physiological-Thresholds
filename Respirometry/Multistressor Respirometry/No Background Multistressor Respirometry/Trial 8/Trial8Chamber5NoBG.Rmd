...
```
I think there may have been some more weird flush timing
...
```
Now we're working better, but there still seem to be some poorly timed flushes.
...
```
Somewhat noisy, but less ridiculous than some other ones
...
#write.csv(corrected.data, "Trial8Chamber5NoBG.csv")
#After we adjust the rates by more correct value
```

I guess it dropped a few, but that's okay.
