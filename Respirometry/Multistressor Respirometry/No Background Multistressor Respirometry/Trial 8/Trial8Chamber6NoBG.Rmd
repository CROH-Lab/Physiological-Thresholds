...
```
Kind of noisy and all over the place again.
...
```
That mostly looks okay, but off to a weird start
...
```
Why do I get the distinct impression we stared out with supersaturated oxygen
...
#write.csv(corrected.data, "Trial8Chamber6NoBG.csv")
#After we adjust the rates by more correct value
```
Ended up a little weird, but hopefully fixable
