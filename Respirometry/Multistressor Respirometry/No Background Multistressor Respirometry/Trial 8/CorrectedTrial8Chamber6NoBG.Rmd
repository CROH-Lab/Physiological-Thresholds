---
title: "CorrectedTrial8Chamber6NoBG"
author: "Abby Cannon"
date: "2024-10-25"
...
```{r}
horas.malas <- c(2, 3, 4, 27, 29, 32, 35, 40, 43, 46, 50, 53, 54, 56, 59, 
                 62, 74)
```
...
```
Came out less weird than some from here
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 8 Chamber 6") + geom_hline(aes(yintercept=0)) +
...
#write.csv(corrected.data, "CorrectedTrial8Chamber6NoBG.csv")
