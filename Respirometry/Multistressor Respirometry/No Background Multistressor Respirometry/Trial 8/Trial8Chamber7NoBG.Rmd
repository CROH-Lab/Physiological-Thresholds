...
```
Well at least it starts off around 100%
...
```
Remembering that the axis is negative, although this is still weird.
...
```
Just as weird as the rest of the ones from this trial.
...
#write.csv(corrected.data, "Trial8Chamber7NoBG.csv")
