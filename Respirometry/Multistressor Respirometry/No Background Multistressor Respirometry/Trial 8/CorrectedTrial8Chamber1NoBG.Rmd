...
```
So these loops look good except for 9, but the numbering shifted.
...
```
Alright. Now we look better there
...
#write.csv(corrected.data, "CorrectedTrial8Chamber1NoBG.csv")
