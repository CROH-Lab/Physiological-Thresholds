...
```
A certain amount of cycling once it rolls.
...
ggplot(data_c1, aes(x=loop, y=mo2)) + geom_point() + theme_classic() +
  ggtitle("OFAV Trial 10 Chamber 4") + geom_hline(aes(yintercept=0)) +
...
#write.csv(corrected.data, "Trial10Chamber4NoBG.csv")
