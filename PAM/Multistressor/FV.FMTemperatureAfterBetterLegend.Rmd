---
title: "FV.FmBayesianLinearModelAfter"
author: "Abby Cannon"
date: "2024-10-30"
...
```{r}
fluoro <- aggregate(Fv.Fm ~ Coral.ID + Temperature + Turbidity + Genotype +
...
bayes_rm <- generalTestBF(Fv.Fm ~ Temperature * Turbidity + Genotype, 
...
```{r}
ggsave(p2, 
       filename = "Fv.FMPhase2AfterTreatmentBetterLegend.png",
       device = "png")
```