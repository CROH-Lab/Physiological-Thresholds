---
title: "ETRm Over Time by Treatment"
author: "Abby"
date: "2024-08-17"
...
#write.csv(datos.days, "ETRmTreatmentDays.csv") 
#We'll need this for subsequent data focusing.

#But first we need some stats
library(Rmisc)

#How we calculate
PAM.stats = summarySE(datos.days, measurevar="ETRm", 
...
library(ggplot2)
library(ggpubr)
p1 <- ggplot(PAM.stats, aes(x=Days.Post.Experiment, y=ETRm, colour=Treatment)) + 
 ...
 scale_color_manual(values = c("black", "#000080", "#FF0000", "#00CD00"),
  ...
  ggtitle("ETRm by Treatment Over Time")
