...
bayes_rm
```
So this time only Genotype is the most likely
...
look.at.this
```
0.36 times as likely as just treatment
...
```{r}
#So now we make our Bayesian Models
bayes_rm.threshold <- generalTestBF(ETRm ~ At.or.Above.Legal.Threshold + Genotype, 
                          data = fluoro, whichRandom = "Genotype", 
                          neverExclude = "Genotype")
```
...
bayes_rm.threshold
```
Less likely. So I guess this ¿works?
