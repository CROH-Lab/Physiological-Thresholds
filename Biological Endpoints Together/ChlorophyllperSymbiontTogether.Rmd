---
title: "Chlorophyll per Symbiont Together"
author: "Abby Cannon"
date: "2024-11-30"
...
bayes_rm <- generalTestBF(Chl.a.c.2.per.symbiont..x1000. ~ Turb * 
                            Temp * Phase + Genotype, 
...
bayes_rm
```
Everybody is less likely than random noise.

What about changes?
What about when we look at offset
```{r}
#So now we make our Bayesian Models
bayes_rm.change.Chl.per.symbiont.<- 
  generalTestBF(change.Chl.per.symbiont ~ Turb * 
                            Temp*Phase + Genotype, 
                          data = cambios, whichRandom = "Genotype", 
                          neverExclude = "Genotype")
```
